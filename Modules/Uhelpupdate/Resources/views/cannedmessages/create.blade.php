        ...
        @endsection
							...
							<div class="page-header d-xl-flex d-block">
								<div class="page-leftheader">
									<h4 class="page-title"><span class="font-weight-normal text-muted ms-2">{{trans('uhelpupdate::langconvert.admindashboard.cannedmessagescreate')}}</span></h4>
								</div>
							</div>
							<!--End Page header-->
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12">
                                <div class="card">
                                    <div class="card-header border-0">
                                        <h4 class="card-title">{{trans('uhelpupdate::langconvert.admindashboard.cannedmessagescreate')}}</h4>
                                    </div>
