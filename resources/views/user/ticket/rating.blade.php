                                                        ...
                                                        <div class="">
                                                            <div class="rattings mt-4">
                                                                <div class="d-flex rate">
                                                                    <a href="{{url('customer/rating/star1/'.$item->user->id)}}" class="emoji text-center">
                                                                    ...
                                                                    <a href="{{url('customer/rating/star2/'.$item->user->id)}}" class="emoji text-center">
                                                                    ...
                                                                    <a href="{{url('customer/rating/star3/'.$item->user->id)}}" class="emoji text-center">
                                                                    ...
                                                                    <a href="{{url('customer/rating/star4/'.$item->user->id)}}" class="emoji text-center">
                                                                    ...
                                                                    <a href="{{url('customer/rating/star5/'.$item->user->id)}}" class="emoji text-center">
